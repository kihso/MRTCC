...
wind=create_windfield_no_taylor(farm);
...
[file,path]=uiputfile('*.mdl','Save Wind Farm Model As','windfarm_no_taylor_add_turbulence.mdl');
...
%close system stuff
gen_windfarm_no_taylor_add_turbulence(file,path,farm,wind);
